...
_DEFAULT_OUTPUT_GROUP_SPECS: tuple[OutputGroupSpec, ...] = (
    ...
    OutputGroupSpec(
        ...
        blank_row_after_group=True,
        notes="Source-file-order group; legacy FORM rows 38/42 are not placement targets.",
    ),
    OutputGroupSpec(
    ...
    OutputGroupSpec(
        ...
        cost_items=("birthday",),
        blank_row_after_group=True,
        notes="Source-file-order row; legacy FORM rows 59/63 are not placement targets.",
    ),
    OutputGroupSpec(
    ...
    OutputGroupSpec(
        ...
        blank_row_after_group=True,
        notes="Source-file-order row; legacy FORM row 137 is not a placement target.",
    ),
)
