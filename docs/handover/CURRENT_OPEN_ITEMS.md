...
|---|---|---|---|
| UNIFORM-CUP | `IMPLEMENTED_PENDING_ACCEPTANCE` | Đã nạp đủ 65 phòng × 16 cột F:U (1.040 dấu chọn), xác nhận 0 phòng chọn trùng áo và đúng 4 phòng chỉ dùng áo polo. Bộ tính mới xử lý người mới, lịch cấp áo tháng 2/tháng 10, cốc người mới theo công nhân, cốc định kỳ nhập tay, chặn dữ liệu mơ hồ và lưu nhật ký chi tiết. Kiểm thử riêng đạt 10/10; lần chạy xuyên suốt FY2027 cho CC `1412000036` thành công, tính áo polo tháng 7 là 278.000 đồng và áo dài tay bổ sung tháng 10 là 350.000 đồng. | Người làm nghiệp vụ kiểm tra một file xuất mẫu và xác nhận cách trình bày/gộp dòng chi phí trong FORM. |
